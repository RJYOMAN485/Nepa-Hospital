    ...
    <table width="200" border="3">
      <tbody>
        <tr>
          ...
          <td width="66%"><input type="text" required name="adminname" id="adminname" value="<?php echo $rsedit[adminname]; ?>"/></td>
        </tr>
        <tr>
          <td>Login ID</td>
        ...
        <tr>
          ...
          <td><input type="password" required name="cnfirmpassword" id="cnfirmpassword" value="<?php echo $rsedit[confirmpassword]; ?>"/></td>
        </tr>
        <tr>
          <td>Status</td>
