...
<div class="wrapper col4">
    ...
    <table width="490" border="3">                
        <tr>
		  ...
		  if(isset($_GET[patid]))
			...
			{
		  ?>
                  <select required name="select4" id="select4">
        ...
        <tr>
          <td>Department</td>
          <td><select required name="select5" id="select5">
           <option value="">Select</option>
            <?php
  ...
  echo "<option value='$rsdepartment[departmentid]'>$rsdepartment[departmentname]</option>";
        ...
        <tr>
          ...
          <td><input type="date" required name="appointmentdate" id="appointmentdate" value="<?php echo $rsedit[appointmentdate]; ?>" /></td>
        </tr>
        <tr>
          <td>Appointment Time</td>
          <td><input type="time" required name="time" id="time" value="<?php echo $rsedit[appointmenttime]; ?>" /></td>
        </tr>
        <?php
        ...
        <tr>
          <td>Doctor</td>
          <td>
          <select required name="select6" id="select6">
            <option value="">Select</option>
            <?php
		...
		?>
         <tr>
          ...
          <td><textarea  required name="appreason" id="appreason" style="width:300px;height:100px;"><?php echo $rsedit[app_reason]; ?></textarea></td>
