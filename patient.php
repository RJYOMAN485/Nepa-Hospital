...
?>
        ...
        <tr>
          <td>Mobile Number</td>
          <td><input type="number" pattern="[0-9]{10}" required name="mobilenumber" id="mobilenumber" value="<?php echo $rsedit[mobileno]; ?>" /></td>
        </tr>
        <tr>
          <td>City</td>
        ...
        <tr>
          <td>PIN Code</td>
          <td><input type="number" pattern="[0-9]{9}"  required name="pincode" id="pincode" value="<?php echo $rsedit[pincode]; ?>" /></td>
        </tr>
        <tr>
          <td>Login ID</td>
        ...
        <tr>
          <td>Date Of Birth</td>
          <td><input type="date" required name="dateofbirth" max="<?php echo date("Y-m-d"); ?>" id="dateofbirth"  value="<?php echo $rsedit[dob]; ?>"/></td>
        </tr>
