    ...
    <table width="418" border="3">
      <tbody>
        <tr>
          ...
          <td width="66%"><input type="text" required name="departmentname" id="departmentname" value="<?php echo $rsedit[departmentname]; ?>" /></td>
        </tr>
        <tr>
          <td>Description</td>
          <td><textarea name="textarea" required id="textarea" cols="45" rows="5"><?php echo $rsedit[description] ; ?></textarea></td>
        </tr>
        <tr>
          <td>Status</td>
