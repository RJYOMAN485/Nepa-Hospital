    ...
    <table width="532" border="3">
      <tbody>
        <tr>
          ...
          <td width="66%"><input type="text" name="patiente" required id="patiente" value="<?php echo $rspatient[patientname];  ?>"  <?php echo $readonly; ?> ></td>
        </tr>
        <tr>
          <td height="62">Address</td>
          <td><textarea name="textarea" id="textarea" required <?php echo $readonly; ?>><?php echo $rspatient[address];  ?></textarea></td>
        </tr>
        <tr>
          <td>City</td>
          <td><input type="text" name="city" required id="city" value="<?php echo $rspatient[city];  ?>" <?php echo $readonly; ?> ></td>
        </tr>
        <tr>
          <td>Mobile Number</td>
          <td><input type="text" name="mobileno" required id="mobileno" value="<?php echo $rspatient[mobileno];  ?>" <?php echo $readonly; ?> ></td>
...
?>
        ...
        <tr>
          <td>DOB</td>
          <td><input type="date" required name="dob" id="dob" value="<?php echo $rspatient[dob]; ?>" <?php echo $readonly; ?> ></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input type="time"  required name="appointmenttime" id="appointmenttime"></td>
        </tr>   
        <tr>
          <td><strong>Department</strong></td>
          <td>
          <select  required name="department" id="department" onchange="loaddoctor(this.value)">
		...
		<tr>
          ...
          <td>
			<div id="divdoc">
			  <select name="doct"required id="doct">
        ...
        <tr>
          ...
          <td><textarea required name="app_reason"></textarea></td>
        </tr>
        <tr>
