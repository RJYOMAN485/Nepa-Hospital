    ...
    <table width="200" border="3">
      <tbody>
        ...
        <tr>
          ...
          <td width="66%">
		  <select required name="medicineid" id="medicineid" onchange="showAmount(this.value)">
		...
		{
			echo "<option value='$rsmedicine[medicinecost]'>$rsmedicine[medicinename] ( ₹ $rsmedicine[medicinecost] )</option>";
		}
		?>
		  </select>
		  </td>
        ...
        <tr>
          <td>Cost</td>
          <td><input type="text" name="cost" id="cost" value=""  style="background-color:pink;" /></td>
        </tr>
        <tr>
          <td>Unit</td>
          <td><input type="number" min="1" name="unit" id="unit" value="" onkeyup="calctotalcost()" onchange="" /></td>
        </tr>
        <tr>
          <td>Total Cost</td>
          <td><input type="text" name="totcost" id="totcost" value="<?php //echo $rsedit[cost]; ?>"  style="background-color:pink;" /></td>
        </tr>
        <tr>
          <td>Dosage</td>
...
function showAmount(amt) {
	//alert(amt);
	document.querySelector('#cost').value = amt;	
	document.querySelector('#unit').value = 1;
	document.querySelector('#totcost').value = amt;	
...
function calctotalcost()
{
	 ...
	 document.querySelector('#totcost').value = document.querySelector('#cost').value * document.querySelector('#unit').value;
} 
