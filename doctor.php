...
<div class="wrapper col4">
    ...
    <table width="418" border="3">
      <tbody>
        <tr>
          ...
          <td width="66%"><input type="text" required name="doctorname" id="doctorname" value="<?php echo $rsedit[doctorname]; ?>" /></td>
        </tr>
        <tr>
          <td>Mobile Number</td>
          <td><input type="number" pattern="[0-9]{10}" name="mobilenumber" id="mobilenumber" value="<?php echo $rsedit[mobileno]; ?>"/></td>
        </tr>
        <tr>
          <td>Department</td>
  ...
  echo "<option value='$rsdepartment[departmentid]'>$rsdepartment[departmentname]</option>";
        ...
        <tr>
          ...
          <td><input type="password" required name="cnfirmpassword" id="cnfirmpassword" value="<?php echo $rsedit[password]; ?>"/></td>
        </tr>
        <tr>
          <td>Education</td>
          <td><input type="text" required name="education" id="education" value="<?php echo $rsedit[education]; ?>" /></td>
        </tr>
        <tr>
          <td>Experience</td>
          <td><input type="text" required name="experience" id="experience" value="<?php echo $rsedit[experience]; ?>"/></td>
        </tr>
        <tr>
          <td>Consultancy Charge</td>
          <td><input type="text" required name="consultancy_charge" id="consultancy_charge" value="<?php echo $rsedit[experience]; ?>"/></td>
        </tr>
        <tr>
          <td>Status</td>
          <td><select required name="select" id="select">
            <option value="">Select</option>
            <?php
