    ...
    <table width="200" border="3">
      <tbody>
        <tr>
          ...
          <td width="66%"><input type="text" required pattern="[A-Za-z]+" name="patientname" id="patientname"  value="<?php echo $rsedit[patientname]; ?>"/></td>
        </tr>
<?php
if(isset($_GET[editid]))
{
?>       
        <tr>
          ...
          <td><input type="date" required name="admissiondate" id="admissiondate" value="<?php echo $rsedit[admissiondate]; ?>" readonly /></td>
        </tr>
        <tr>
          <td>Admission Time</td>
          <td><input type="time" required name="admissiontme" id="admissiontme" value="<?php echo $rsedit[admissiontime]; ?>" readonly /></td>
        </tr>
<?php
}
?>
        <tr>
          <td>Address</td>
          <td><textarea name="address" required id="address" cols="45" rows="5"><?php echo $rsedit[address]; ?></textarea></td>
        </tr>
        <tr>
          <td>Mobile Number</td>
          <td><input type="number" required pattern="^\d{10}$" name="mobilenumber" id="mobilenumber" value="<?php echo $rsedit[mobileno]; ?>" /></td>
        </tr>
        <tr>
          <td>City</td>
          <td><input type="text" required name="city" id="city" value="<?php echo $rsedit[city]; ?>" /></td>
        </tr>
        <tr>
          <td>PIN Code</td>
          <td><input type="number" pattern="[0-9]{6}" required max="6" name="pincode" id="pincode" value="<?php echo $rsedit[pincode]; ?>" /></td>
        </tr>
        <tr>
          <td>Login ID</td>
          <td><input type="text" required name="loginid" id="loginid"  value="<?php echo $rsedit[loginid]; ?>"/></td>
        </tr>
        <tr>
          <td>Password</td>
          <td><input type="password" required name="password" id="password" value="<?php echo $rsedit[password]; ?>" /></td>
        </tr>
        <tr>
          <td>Confirm Password</td>
          <td><input type="password" required name="confirmpassword" id="confirmpassword"  value="<?php echo $rsedit[confirmpassword]; ?>"/></td>
        </tr>
        <tr>
          <td>Blood Group</td>
          <td><select  required name="select2" id="select2">
        ...
        <tr>
          <td>Gender</td>
          <td><select required name="select3" id="select3">
           <option value="">Select</option>
          <?php
        ...
        <tr>
          <td>Date Of Birth</td>
          <td><input required type="date" name="dateofbirth" max="<?php echo date("Y-m-d"); ?>" id="dateofbirth"  value="<?php echo $rsedit[dob]; ?>"/></td>
        </tr>
