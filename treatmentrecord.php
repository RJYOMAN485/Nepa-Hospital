...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      <li class="first">Add New treatment records</li></ul>
  </div>
</div>
<div class="wrapper col4">
  <div id="container">
    ...
    <table width="258" border="3">
      <tbody>
        <tr>
          <td width="40%">Appointment</td>
          <td width="60%">
          <input type="text" readonly name="select2" value="<?php echo $_GET[appid]; ?>"  /></td>
        </tr>
        <tr>
          <td>Patient</td>
          <td>
...
?>			
        ...
        <tr>
          ...
          <td>          
          <select name="select4" required id="select4">
        ...
        <tr>
          ...
          <td><textarea name="textarea" id="textarea" required cols="45" rows="5"><?php echo $rsedit[treatment_description] ; ?></textarea></td>
        </tr>
        <tr>
          <td>Treatment files</td>
          <td><input type="file" required name="uploads" id="uploads" value="<?php echo $rsedit[uploads]; ?>" /></td>
        </tr>
        <tr>
          <td>Treatment date</td>
          <td><input type="date" required max="<?php echo date("Y-m-d"); ?>" name="treatmentdate" id="treatmentdate" value="<?php echo $rsedit[treatment_date]; ?>" /></td>
         
        </tr>
        <tr>
          <td>Treatment Time</td>
          <td><input type="time" required name="treatmenttime" id="treatmenttime" value="<?php echo $rsedit[treatment_time]; ?>" /></td>
        </tr>
        <tr>
          <td colspan="2" align="center"><input type="submit" name="submit" id="submit" value="Submit" /> | <a href='patientreport.php?patientid=<?php echo $_GET[patientid]; ?>&appointmentid=<?php echo $_GET[appid]; ?>'><strong>View Patient Report>></strong></a></td>
        </tr>
      </tbody>
    </table>
    </form>
