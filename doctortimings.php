    ...
    <table width="445" border="3">
      <tbody>
        ...
        <tr>
          ...
          <td width="66%"><select required name="select2" id="select2">
        ...
        <tr>
          ...
          <td><input type="time" required name="ftime" id="ftime" value="<?php echo $rsedit[start_time]; ?>"></td>
        </tr>
        <tr>
          <td height="34">To</td>
          <td><input type="time" required name="ttime" id="ttime"  value="<?php echo $rsedit[end_time]; ?>" ></td>
        </tr>
        <tr>
